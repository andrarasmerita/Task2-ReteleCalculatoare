    ...
    try:
        ...
        if comanda in ['PUBLISH', 'DELETE', 'LIST'] and adresa_client not in clienti_conectati:
            ...
            if not argumente:
                ...
                mesaje[id_mesaj_curent] = {"autor": adresa_client, "text": argumente}
            ...
            if not argumente.isdigit():
                ...
                if id_sters in mesaje:
                    ...
                    raspuns = f"EROARE: Mesajul cu ID={id_sters} nu exista."
            ...
            if not mesaje:
                ...
                linii = ["Lista mesaje:"]
                for mid, mdata in mesaje.items():
                    linii.append(f"[{mid}] {mdata['text']}")
                raspuns = "\n".join(linii)
